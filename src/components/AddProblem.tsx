            ...
            <div>
                <form aria-label="Enter problem details">
                    ...
                    <div className="problem-name">
                        ...
                        <input id="add-problem-name" className="border-teal-400" type="text" />
                    </div>
                    {/*Problem Link*/}
                    <div className="problem-link">
                        <label htmlFor="add-problem-link">Link:</label>
                        <input type="url" id="add-problem-link" className="border-teal-400"/>
                    </div>

                    {/*Problem Category*/}
                    <div className="problem-category">
                        <label htmlFor="add-problem-category">Category:</label>
                        <select id="add-problem-category" className="border-teal-400">
                    ...
                    <div className="problem-difficulty">
                        ...
                        <select id="add-problem-difficulty" className="border-teal-400">
                    ...
                    <div className="problem-notes">
                        ...
                        <EditorCard id="add-problem-notes" className="border-teal-500 text-green"/>
                    </div>
                </form>
            </div>
        </div>
